...
export const QUESTIONS = {
  morning: [
    ...
    {
      text: 'Мої головні цілі цього місяця.',
    ...
    },
    {
      ...
      hint: 'Напиши 3 чіткі кроки, які зроблять твій день продуктивним. Формат: дія — час — результат.',
      field: 'Q_m_6'
    }
  ], 
  evening: [
...
WELCOME_BACK_ACTIVE: (userName, endStr, stats = {}) =>
  ...
  `• 🌙 Вечірня рефлексія — о ${SCHEDULE.EVENING_TIME}\n` +
  `• 📊 Щотижневий звіт — щонеділі\n` +
  `• 🎯 Колесо балансу — 1 числа місяця\n\n` +
  `💡 **Що можу для тебе зробити:**\n` +
  `• 🤖 AI-наставник — підтримка 24/7\n` +
  `• 🛞 Колесо балансу — аудит 8 сфер життя\n` +
  `• 📊 Мій прогрес — звіти та статистика\n` +
  `• 💎 Афірмація — щоденна мотивація\n\n` +
  `Використовуй меню внизу або обирай дію 👇`,
...
WELCOME_BACK_INACTIVE: (userName, stats = {}) =>
  ...
  `• ✅ Виконано сесій: ${stats.completedSessions || 0}\n` +
  `• 🎯 Колесо балансу: ${stats.wheelCompleted ? '✅ Заповнено' : '❌ Не заповнено'}\n\n` +
  `💡 **Доступно без підписки:**\n` +
  `• 📊 Мій прогрес — переглянути статистику\n` +
  `• 💰 Підписка — оформити або продовжити\n` +
  `• 📞 Зв'язок — отримати підтримку\n\n` +
  `Використовуй меню внизу або обирай дію 👇`,
...
WELCOME_BACK_INACTIVE: (userName, stats = {}) =>
  ...
  `• 💰 Підписка — оформити або продовжити\n` +
  `• 📞 Зв'язок — отримати підтримку\n\n` +
  `Використовуй меню внизу 👇 або очікуй на заплановані рефлексії`,
...
REGISTRATION_INFO: (userData) => 
  ...
  AFTER_WHEEL_INFO: 
    ...
    `Що далі:\n\n` +
    `🌞 Ранкова рефлексія (08:00)\n` +
    `🌙 Вечірня рефлексія (21:30)\n` +
    `📊 Щотижневі звіти\n` +
    `🤖 AI Наставник 24/7\n` +
    `🎯 Щомісячне колесо`,
  ...
  ASK_PLAN: 'Обери план доступу. Можеш почати з безкоштовного пробного тижня.\n\n'+
    ...
    // '🧪 Пробний період (7 днів) — 0€\n' +
    // '📅 Тиждень фокусу — 7€\n' +
    // '🎯 Місяць дії — 30€\n' +
    // '⭐ Рік трансформації — 300€\n\n' +
    '💡 Можеш завершити реєстрацію без підписки, але AI-функції будуть недоступні.',
...
WELCOME_BACK_ACTIVE: (userName, endStr, stats) =>
  ...
  `• 📈 Прогрес по цілях: ${stats.goalProgress || 0}%\n\n` +
  `⏰ **Нагадування:**\n` +
  `• 🌞 Ранкова рефлексія — о 12:58\n` +
  `• 🌙 Вечірня рефлексія — о 15:00\n` +
  `• 📊 Щотижневий звіт — щонеділі\n` +
  `• 🎯 Колесо балансу — 1 числа місяця\n\n` +
  `💡 **Що можу для тебе зробити:**\n` +
  `• 🤖 AI-наставник — підтримка 24/7\n` +
...
// В кінці файлу constants.js додати:
